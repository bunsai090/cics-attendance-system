...
class FormValidator {
  ...
  static validateField(field) {
    ...
    if (field.hasAttribute('data-confirm')) {
      const confirmFieldName = field.getAttribute('data-confirm');
      const confirmField = document.querySelector(`[name="${confirmFieldName}"]`);
      if (confirmField) {
  ...
  static init() {
    ...
    document.querySelectorAll('input, select, textarea').forEach(field => {
      ...
      if (field.type === 'password' && field.name === 'password') {
        // When main password changes, re-validate confirm password if it has a value
        field.addEventListener('input', () => {
          const confirmField = document.querySelector('[data-confirm="password"]');
      ...
      // For confirm password, validate on every input to clear errors quickly
      if (field.hasAttribute('data-confirm')) {
        field.addEventListener('input', () => {
...
function initPasswordToggle() {
  document.querySelectorAll('.password-toggle').forEach(toggle => {
    toggle.addEventListener('click', (e) => {
      ...
      // Find the input-group container and then the input field
