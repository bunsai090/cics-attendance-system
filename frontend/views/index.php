...
<head>
  ...
  <title>CICS Students Access and Attendance System - ZPPSU</title>
  ...
  <header class="header">
    <div class="header-container">
      <div class="header-logo">
        <img src="https://uploadthingy.s3.us-west-1.amazonaws.com/h5rtnYfu5NzN7nEjkomYz5/ZPPSU-LOGO.jpg" alt="ZPPSU Logo" class="logo-img">
    ...
    <div class="hero-container">
      <div class="hero-content">
        ...
        <p class="hero-description">
          A secure and efficient system designed for the College of Information and Computing Sciences (CICS) at ZPPSU. It streamlines student attendance tracking, provides real-time monitoring for instructors and administrators, and ensures parents are automatically informed.
        </p>
      ...
      <div class="hero-image">
        ...
        <div class="hero-image-wrapper">
          <img src="https://uploadthingy.s3.us-west-1.amazonaws.com/qHYtTa1uNrpFjc66NgGcuM/ZPPUS-CICS_LOGO.jpg" alt="CICS Logo" class="hero-img">
        </div>
      </div>
    </div>
  </main>
    ...
    <div class="container">
      ...
      <div class="features-grid">
        <div class="feature-card">
          ...
          <h3 class="feature-card-title">Accurate Attendance Tracking</h3>
          <p class="feature-card-description">Start and end class sessions with campus GPS restriction to ensure authentic attendance logs.</p>
        </div>
        <div class="feature-card">
          <div class="feature-card-icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          ...
          <p class="feature-card-description">Parents receive automated email summaries of student attendance daily (Present, Absent, Late).</p>
        </div>
        <div class="feature-card">
          <div class="feature-card-icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          ...
          <h3 class="feature-card-title">Flexible Management Tools</h3>
          <p class="feature-card-description">Admins manage students and instructors, approve requests, and generate reports.</p>
        </div>
        <div class="feature-card">
          <div class="feature-card-icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          ...
          <h3 class="feature-card-title">Comprehensive Reports & Analytics</h3>
          <p class="feature-card-description">Instructors and admins can monitor absences/lateness and export reports to Excel.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="about-content">
        ...
        <div class="about-text">
          ...
          <p class="about-description">
            The CICS Student Access and Attendance System with Automated Parental Notification is a centralized platform designed to strengthen accountability and transparency in student attendance.
          </p>
          ...
          <a href="#contact" class="btn btn-primary">Learn More About CICS</a>
        </div>
      </div>
    </div>
  </section>
