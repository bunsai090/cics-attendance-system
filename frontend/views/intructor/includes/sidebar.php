<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="javascript:void(0)" onclick="Toast.info('Correction Requests feature is coming soon!', 'Future Update')" class="sidebar-nav-item <?php echo ($activePage === 'correction-requests') ? 'active' : ''; ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <a href="javascript:void(0)" onclick="Toast.info('Reports feature is coming soon!', 'Future Update')" class="sidebar-nav-item <?php echo ($activePage === 'reports') ? 'active' : ''; ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  ...
  <div class="sidebar-footer">
    <p>© 2025 - ZPPSU CICS<br>Students Access and Attendance System</p>
  </div>
</aside>